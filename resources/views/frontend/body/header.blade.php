        ...
        <div class="" style="margin:0; padding:0; ">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="index.html"><img src="{{ asset('frontend/assets/imgs/theme/logo-1.svg') }}"
                            alt="logo" /></a>
                </div>
                <div class="header-right">

                    <div class="input-group"> <input type="search" name="q" id="search"
                            class="form-control search-input" autocomplete="off" placeholder="Enter Your Keyword...">
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="shop-cart.html">
                                    <img alt="Nest"
                                        src="{{ asset('frontend/assets/imgs/theme/icons/images.png') }}" />
                            ...
                            <div class="header-action-icon-2">
                                <a href="page-account.html" style="padding-right:5px">
                                    <img class="svgInject" alt="Nest"
                                        src="{{ asset('frontend/assets/imgs/theme/icons/download.png') }}" />
                                </a>
                                @auth
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-22">
                                            <ul>
                                                @foreach ($subcategories as $sub)
                                                    <li><a
                                                            href="shop-product-right.html">{{ $sub->subcategory_name }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </li>
