...
<header class="header-area header-style-1 header-height-2" style="background-color: black !important;" >
    <div class="container" >
            ...
            <!-- header bottom start -->
                                ...
                                <div class="header-bottom header-bottom-bg-color sticky-bar" style="background-color: black !important;">
                                    <div class="container">
                                        <div class="header-wrap header-space-between position-relative">
                                            <div class="logo logo-width-1 d-block d-lg-none">
                                                <a href="index.html"><img src="{{ asset('frontend/assets/imgs/theme/logo.svg') }}" alt="logo" width="100" height="25" /></a>
                                            </div>
                                            <div class="header-nav d-none d-lg-flex">
                                                ...
                                                <nav >
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="shop-grid-right.html">Product <i class="fi-rs-angle-down"></i></a>
                                                                <ul class="sub-menu">
                                        ...
                                        <div class="hotline d-none d-lg-flex">
                                            ...
                                            <p>0182-1587206<span>24/7 Support Center</span></p>
                                        </div>
