...
<div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html">{{$product['brand']['brand_name']}}</a> <span></span> {{$product['category']['category_name']}}<span></span>{{$product['subcategory']['subcategory_name']}}
                </div>
            </div>
        </div>
