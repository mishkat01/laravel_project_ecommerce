          ...
          <i class="fa fa-area-chart"></i> Sales Report 
              <div class="card-action">
                <div class="form-group mb-0">
                  <select class="form-control form-control-sm input-dark">
...
<div class="row">
   ...
   <div class="col-12 col-lg-6 col-xl-4">
     <div class="card bg-transparent shadow-none border border-light-3">
        <div class="card-header bg-transparent text-white border-light-3">Social Traffic</div>
        <div class="card-body">
           <div class="media align-items-center">
             <div><i class="fa fa-facebook-square fa-2x text-facebook"></i></div>
               <div class="media-body text-left ml-3">
                 <div class="progress-wrapper">
                   <p class="text-white">Facebook <span class="float-right">65%</span></p>
            ...
            <div class="media align-items-center">
             <div><i class="fa fa-twitter fa-2x text-twitter"></i></div>
               <div class="media-body text-left ml-3">
                 <div class="progress-wrapper">
                   <p class="text-white">Twitter <span class="float-right">50%</span></p>
                   <div class="progress" style="height: 7px;">
            ...
            <div class="media align-items-center">
             <div><i class="fa fa-dribbble fa-2x text-dribbble"></i></div>
               <div class="media-body text-left ml-3">
                 <div class="progress-wrapper">
                   <p class="text-white">Dribble <span class="float-right">70%</span></p>
                   <div class="progress" style="height: 7px;">
            ...
            <div class="media align-items-center">
             <div><i class="fa fa-linkedin-square fa-2x text-linkedin"></i></div>
               <div class="media-body text-left ml-3">
                 <div class="progress-wrapper">
                   <p class="text-white">Linkedin <span class="float-right">35%</span></p>
                   <div class="progress" style="height: 7px;">
            ...
            <div class="media align-items-center">
             <div><i class="fa fa-youtube-square fa-2x text-youtube"></i></div>
               <div class="media-body text-left ml-3">
                 <div class="progress-wrapper">
                   <p class="text-white">Youtube <span class="float-right">5%</span></p>
                   <div class="progress" style="height: 7px;">
...
<div class="card bg-transparent shadow-none border border-light-3">
  <div class="card-content">
    <div class="row row-group m-0 text-center">
      <div class="col-12 col-lg-3 col-xl-3 border-light-3">
        <div class="card-body">
           <span class="donut" data-peity='{ "fill": ["#5e72e4", "#f2f2f2"], "innerRadius": 45, "radius": 32 }'>4/5</span>
            <hr class="border-light-3">
            <h6 class="mb-0 text-primary">Total Viwes : 4521</h6>
        </div>
      </div>
      <div class="col-12 col-lg-3 col-xl-3 border-light-3">
        <div class="card-body">
          ...
          <hr class="border-light-3">
            <h6 class="mb-0 text-secondary">Page Click : 4521</h6>
        </div>
      </div>
      <div class="col-12 col-lg-3 col-xl-3 border-light-3">
        <div class="card-body">
          <span class="donut" data-peity='{ "fill": ["#2dce89", "#f2f2f2"], "innerRadius": 45, "radius": 32 }'>3/5</span>
           <hr class="border-light-3">
            <h6 class="mb-0 text-success">Server Load : 4521</h6>
        </div>
      </div>
       <div class="col-12 col-lg-3 col-xl-3 border-light-3">
        <div class="card-body">
          <span class="donut" data-peity='{ "fill": ["#fb6340", "#f2f2f2"], "innerRadius": 45, "radius": 32 }'>2/5</span>
           <hr class="border-light-3">
            <h6 class="mb-0 text-warning">Used RAM : 4521</h6>
        </div>
      </div>
    </div><!--End Row-->
  </div>
