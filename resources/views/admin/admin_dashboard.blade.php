...
<head>
  ...
  <link rel="stylesheet" href="{{asset('adminbackend//assets/vendors/mdi/css/materialdesignicons.min.css')}}">
  <link rel="stylesheet" href="{{asset('adminbackend//assets/vendors/css/vendor.bundle.base.css')}}">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="{{asset('adminbackend/assets/vendors/flag-icon-css/css/flag-icon.min.css')}}">
  <link rel="stylesheet" href="{{asset('adminbackend/assets/vendors/jvectormap/jquery-jvectormap.css')}}">
  <!-- End plugin css for this page -->
  <!-- Layout styles -->
  <link rel="stylesheet" href="{{asset('adminbackend/assets/css/demo/style.css')}}">
  <!-- End layout styles -->
  <link rel="shortcut icon" href="{{asset('adminbackend/assets/images/favicon.png')}}" />
</head>
<body>
<script src="{{asset('adminbackend/assets/js/preloader.js')}}/"></script>
  ...
  <!-- plugins:js -->
  <script src="{{asset('adminbackend/assets/vendors/js/vendor.bundle.base.js')}}"></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <script src="{{asset('adminbackend/assets/vendors/chartjs/Chart.min.js')}}"></script>
  <script src="{{asset('adminbackend/assets/vendors/jvectormap/jquery-jvectormap.min.js')}}"></script>
  <script src="{{asset('adminbackend/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
  <!-- End plugin js for this page-->
  <!-- inject:js -->
  <script src="{{asset('adminbackend/assets/js/material.js')}}"></script>
  <script src="{{asset('adminbackend/assets/js/misc.js')}}"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="{{asset('adminbackend/assets/js/dashboard.js')}}"></script>
